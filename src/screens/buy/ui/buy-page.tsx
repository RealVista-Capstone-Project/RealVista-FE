        ...
        <div className='mx-auto max-w-7xl'>
          <div className='mb-6 flex items-center justify-between'>
            <p className='text-lg text-gray-700'>
              <span className='font-semibold text-main-black'>856</span> {t('results')}
            </p>
            <select className='rounded-lg border border-gray-300 px-4 py-2 text-sm focus:border-main-primary focus:outline-none focus:ring-2 focus:ring-main-primary/20'>
            ...
            {[1, 2, 3, 4, 5, 6].map((item) => (
              ...
              >
                ...
                <div className='p-4'>
                  ...
                  <p className='mb-2 text-sm text-gray-600'>Quận {item}, TP. Hồ Chí Minh</p>
                  <div className='mb-3 flex items-center gap-4 text-sm text-gray-600'>
                    <span>{item + 1} phòng ngủ</span>
                    <span>•</span>
                    <span>{item + 1} phòng tắm</span>
                    <span>•</span>
                    <span>{80 + item * 10}m²</span>
                  </div>
                  <p className='text-xl font-bold text-main-primary'>
                    {((item + 2) * 500).toLocaleString('vi-VN')} triệu VNĐ
                  </p>
                </div>
              </div>
            ))}
