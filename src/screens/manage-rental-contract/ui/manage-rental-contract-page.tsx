  ...
  return (
    <div className='min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(122,92,255,0.10),_transparent_28%),linear-gradient(180deg,#F6F4FF_0%,#F9F8FE_32%,#F7F7FD_100%)]'>
      <div className='mx-auto px-6 py-6'>
        <div className='mb-6 rounded-[32px] border border-white/60 bg-[linear-gradient(135deg,rgba(255,255,255,0.96),rgba(246,243,255,0.92))] p-6 shadow-[0_20px_60px_rgba(96,72,179,0.08)] backdrop-blur-md'>
          <div className='flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between'>
            ...
            <div className='grid gap-3 sm:grid-cols-2 xl:min-w-[360px]'>
              <div className='rounded-[24px] border border-[#ECE9FB] bg-white/80 p-4'>
        ...
        <div className='flex flex-col items-start gap-6 lg:flex-row'>
          <div
            className={cn(
              ...
              selectedContract ? 'lg:flex-1' : 'w-full'
            )}
          >
            <div className='mb-5 flex flex-col gap-3 rounded-[28px] border border-white/60 bg-white/90 p-4 shadow-[0_12px_36px_rgba(94,74,175,0.08)] sm:flex-row sm:items-center'>
              <div className='flex w-full flex-shrink-0 items-center gap-2 sm:w-auto'>
                <SlidersHorizontal className='h-4 w-4 flex-shrink-0 text-main-secondary/50' />
                <Select value={statusFilter} onValueChange={setStatusFilter}>
                  <SelectTrigger className='h-10 w-full rounded-2xl border-transparent bg-[#F5F3FF] text-sm font-medium focus:ring-main-primary/20 sm:w-48'>
              ...
              <div className='relative w-full flex-1'>
                ...
                <Input
                  ...
                  className='h-10 rounded-2xl border-transparent bg-[#F5F3FF] pl-9 text-sm focus-visible:ring-main-primary/20'
                />
              </div>
            </div>

            <div className='overflow-hidden rounded-[30px] border border-white/70 bg-white shadow-[0_18px_48px_rgba(96,72,179,0.10)]'>
              ...
              <div className='min-h-[420px]'>
                {contracts.length === 0 ? (
                  <div className='flex h-[420px] flex-col items-center justify-center gap-4 px-6 text-center'>
                    <div className='flex h-16 w-16 items-center justify-center rounded-[24px] bg-[#F1ECFF]'>
