  ...
  return (
    <>
      <div className='flex gap-4'>
        {/* Boost Card */}
        <div className='flex flex-col rounded-lg border border-primary/20 bg-primary/5 p-4 w-full'>
          ...
          {isLoading ? (
            ...
            <div className='rounded-md border border-primary/20 bg-white p-3 text-center'>
              ...
              <p className='mt-1 text-xs text-muted-foreground'>{t('boost.noPackageDescription')}</p>
  ...
  return (
    <div className='flex items-center justify-between rounded-md border border-primary/20 bg-white px-3 py-2'>
      <div className='flex items-center gap-2'>
        ...
        <span className='text-xs text-muted-foreground'>{t('boost.remaining', { count: remaining })}</span>
        {isActive && (
