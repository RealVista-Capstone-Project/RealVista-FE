...
export const EngagementSearchHeader = ({
  ...
  return (
    <div className='bg-white border-b border-gray-200 sticky top-0 z-20 px-4 py-3 flex items-center gap-3'>
      ...
      <Select value={statusFilter} onValueChange={onStatusFilterChange}>
        <SelectTrigger className='w-40 bg-gray-50 border-gray-200 rounded-lg text-sm text-gray-700 h-9 flex-shrink-0'>
