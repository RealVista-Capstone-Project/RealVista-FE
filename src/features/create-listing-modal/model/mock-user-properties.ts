...
export const mockUserProperties: UserProperty[] = [
  {
    ...
    extraAttributes: [
      ...
      {
        attribute_id: 'attr-005',
        attribute_code: 'FURNISHING',
        attribute_name: 'Furnishing',
        icon: 'sofa',
        unit: null,
        value_number: null,
        value_text: 'Fully Furnished',
        value_boolean: null,
      }
    ],
  },
