  ...
  return (
    <>
      <div className='bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden sticky top-4'>
        {/* Profile header */}
        <div className='px-6 pt-6 pb-5 flex flex-col items-center bg-gradient-to-br from-indigo-50 via-purple-50/30 to-white border-b border-gray-100 relative'>
          ...
          <section>
            <div className='grid grid-cols-3 gap-2.5 text-center'>
              <div className='bg-gray-50 rounded-xl p-3 border border-gray-100'>
                <Briefcase className='h-4 w-4 text-indigo-400 mx-auto mb-1.5' />
              ...
              <div className='bg-gray-50 rounded-xl p-3 border border-gray-100'>
                <Award className='h-4 w-4 text-purple-400 mx-auto mb-1.5' />
