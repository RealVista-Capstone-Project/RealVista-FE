...
This project is indexed by GitNexus as **realvista-fe** (4189 symbols, 9711 relationships, 225 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
