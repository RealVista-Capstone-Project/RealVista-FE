...
This project is indexed by GitNexus as **RealVista-FE** (1584 symbols, 3252 relationships, 52 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
