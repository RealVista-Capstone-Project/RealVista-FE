...
This project is indexed by GitNexus as **realvista-fe** (3647 symbols, 8351 relationships, 224 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
