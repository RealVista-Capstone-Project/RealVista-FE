...
This project is indexed by GitNexus as **RealVista-FE** (3241 symbols, 7147 relationships, 161 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
