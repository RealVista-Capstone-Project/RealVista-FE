...
This project is indexed by GitNexus as **RealVista-FE** (3450 symbols, 7777 relationships, 199 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
