...
This project is indexed by GitNexus as **RealVista-FE** (2230 symbols, 4756 relationships, 102 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
